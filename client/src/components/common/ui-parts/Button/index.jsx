...
const Button = (props) => {
    ...
    const onLoadingButtonClick = useMemo(
        () => {
            ...
            const onClickWithLoader = () => Promise.resolve().then(() => {
                setLoading(true);
                return onClick();
            }).finally(() => {
                setLoading(false);
            ...
            return _.debounce(internalOnClick, debounceTime, { leading: true, trailing: false });
        },
    ...
    const newProps = {
        ...
        ..._.omit(props, ["loading", "disabled", "debounceTime", "onClick", "className", "wrapperClassName", "buttonType"]),
    };

    return (
        <div className={clx(s.wrapper, wrapperClassName)}>
            <button type="button" className={clx(`button${buttonType}`, customClassName)} {...newProps} />
